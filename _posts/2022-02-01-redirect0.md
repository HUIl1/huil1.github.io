...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image8.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image9.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="assets/img/image10.jpg" class="img-fluid rounded z-depth-1" zoomable=true %}
    </div>
</div>
<div class="caption">
...
|:---:|:---------:|:------------------------------:|
|  1  | 0.9473587 | GLM_1_AutoML_2_20221129_231929 |
...
|        | 사용된 검사 |      |      |Train Data|      |        |Test Data|      |검사 수|검사비(원)|리더모델|
|  환경  |  뇌  | 행동 | AUC | 민감도 | 특이도 | AUC |민감도|특이도|     |     |     |
|:------:|:----:|:----:|:----:|:-------:|:---:|:----:|:-----:|:-----:|:-----:|:-----:|:-----:|
|Demographic information| fMRI | CBCL |0.97168|0.97133|0.94995|0.9464|0.94915|0.93447|  3  |353,050| GLM |
|     |  GM  | CBCL |0.96416|0.94386|0.94753|0.96239|0.94309|0.94349|  2  |453,050| GLM |
